...
//   PURPOSE: Language adapter for Kotlin (.kt) and Kotlin Script (.kts) files.
//   SCOPE: Heuristic export analysis via regex; test-role and script-role detection.
//   DEPENDS: types, source-scan
//   LINKS: M-LINT-ADAPTERS
// END_MODULE_CONTRACT
//
// START_MODULE_MAP
//   createKotlinAdapter - Factory for the Kotlin LanguageAdapter.
// END_MODULE_MAP
//
// START_CHANGE_SUMMARY
//   LAST_CHANGE: [v1.5.1 - fix: DECL_RE type-param clause handles nested angle brackets (e.g. <T : Comparable<T>>)]
// END_CHANGE_SUMMARY
