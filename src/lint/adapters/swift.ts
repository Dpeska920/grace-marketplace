...
//   PURPOSE: Language adapter for Swift source files.
//   SCOPE: Heuristic export analysis for public/open declarations; test-role detection.
//   DEPENDS: types, source-scan
//   LINKS: M-LINT-ADAPTERS
// END_MODULE_CONTRACT
//
// START_MODULE_MAP
//   createSwiftAdapter - Factory for the Swift LanguageAdapter.
// END_MODULE_MAP
//
// START_CHANGE_SUMMARY
//   LAST_CHANGE: [v1.5.1 - docs: document single-line extension and init/subscript dedup limitations]
// END_CHANGE_SUMMARY
...
function extractSwiftPublicExports(text: string): SwiftExportSets {
  ...
  for (let idx = 0; idx < lines.length; idx++) {
    ...
    if (kw === "extension") {
      ...
      // exportsComplete stays false — member extraction is heuristic.
